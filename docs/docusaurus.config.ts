...
const config: Config = {
  ...
  organizationName: 'ashen-dusk', // Usually your GitHub org/user name.
  projectName: 'mcp-redis', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl:
            'https://github.com/ashen-dusk/mcp-redis/tree/main/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/ashen-dusk/mcp-redis',
          position: 'right',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              html: `
                <a href="https://github.com/ashen-dusk/mcp-redis" target="_blank" rel="noreferrer noopener" aria-label="GitHub" class="footer__link-item">
